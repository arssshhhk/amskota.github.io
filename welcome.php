...
<nav class="nav bar">
	...
	<main>
		<section>
            <div class="content">
            <img src="logorail.PNG" width="170px" style="display: block; margin-left: auto; margin-right: auto; margin-top: 30px;">
			...
			<div class="click">
            <a href="inspection.php" style="margin:10px;" class="btnone">Inspection Entries</a><br><br><br>
            <a href="reports.php"  class="btnone">Get Report</a>
            </div>
